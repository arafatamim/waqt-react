...
class Settings extends React.Component<Props> {
  state: SettingsObject = { timeFormat: 'h:mm A', calcMethod: 'karachi', lateAsr: true };
...
const RadioButtonGroup: React.FC<{ lateAsr: boolean; emitChange: (e: any) => void }> = props => {
  ...
  return (
    <ButtonsWrapper>
      <RadioButton
        ...
        value="earlier"
        id="button1"
        checked={props.lateAsr ? false : true}
        onChange={handleChange}
      />
      <label htmlFor="button1">Earlier</label>
      <RadioButton
        type="radio"
        value="later"
        id="button2"
        checked={props.lateAsr ? true : false}
        onChange={handleChange}
      />
      <label htmlFor="button2">Later</label>
    </ButtonsWrapper>
  );
};
